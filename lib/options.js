 ...
 *
 * @typedef {'extensions' | 'ignoreName' | 'packageField' | 'pluginPrefix' | 'processor' | 'rcName'} RequiredEngineKeys
 * @typedef {{[Key in RequiredEngineKeys]: Exclude<EngineOptions[Key], null | undefined>}} RequiredEngineFields
 *
 * @typedef {'cwd'} OptionalEngineKeys
 * @typedef {{[Key in OptionalEngineKeys]?: EngineOptions[Key]}} OptionalEngineFields
 *
 * @typedef ArgsFields
 ...
 *
 * @typedef {RequiredEngineFields & OptionalEngineFields & ArgsFields} Options
 */
